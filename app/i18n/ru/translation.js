const ru = {
  translation: {
    ...
    oneMinuteMigrationPage: {
      ...
      info:
        'Импортируйте существующие электронные журналы от сторонних поставщиков, таких как OJS. Это лучший сервис.',
      notice:
    ...
    oneMinuteMigrationPage: {
      ...
      getAbout: 'Ищу страницу "О нас"...',
      info:
        'Импортируйте существующие электронные журналы от сторонних поставщиков (например, OJS) с помощью API Crossref. Это лучший сервис.',
      notice:
        'Примечание. Все предыдущие данные миграции будут удалены, если будет отправлен новый ISSN.',
    },
    reportsPage: {
    ...
    betaFunctionality: {
      title: 'Бета-функциональность',
      label:
        'Обратите внимание, что этот функционал все еще находится в стадии разработки. Используйте по своему усмотрению.',
    },
  },
}
