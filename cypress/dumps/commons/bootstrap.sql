...
UPDATE configs SET form_data = '{"user": {"isAdmin": false, "kotahiApiTokens": null}, "report": {"showInMenu": true}, "review": {"showSummary": false}, "dashboard": {"showSections": ["submission", "review", "editor"], "loginRedirectUrl": "/dashboard"}, "kotahiApis": {}, "manuscript": {"tableColumns": "shortId, submission.$title, created, updated, status, author", "paginationCount": 10}, "publishing": {"webhook": {"ref": null, "url": "https://someserver/webhook-address", "token": null}, "crossref": {"login": null, "password": null, "doiPrefix": null, "licenseUrl": null, "registrant": null, "useSandbox": true, "journalName": null, "depositorName": null, "depositorEmail": null, "journalHomepage": null, "publicationType": "article", "journalAbbreviatedName": null, "publishedArticleLocationPrefix": null}, "hypothesis": {"group": null, "apiKey": null, "reverseFieldOrder": false, "shouldAllowTagging": false}}, "submission": {"allowAuthorsSubmitNewVersion": false}, "taskManager": {"teamTimezone": "Etc/UTC"}, "controlPanel": {"showTabs": ["Team", "Decision", "Manuscript text", "Metadata", "Tasks & Notifications"], "hideReview": true, "sharedReview": true, "authorProofingEnabled": false, "displayManuscriptShortId": true}, "instanceName": "journal", "notification": {"gmailAuthEmail": null, "gmailSenderEmail": null, "gmailAuthPassword": null}, "groupIdentity": {"logoPath": "/assets/logo-kotahi.png", "brandName": "journal", "primaryColor": "#3aae2a", "secondaryColor": "#9e9e9e"}, "eventNotification": {"authorProofingSubmittedEmailTemplate": "2b447eaf-89a1-44c9-8e29-198a76e5d03b", "authorProofingInvitationEmailTemplate": "bcd417fc-5762-461c-ad01-aaea42e09bff", "reviewerInvitationPrimaryEmailTemplate": "afb93d17-60dd-44ec-8ceb-b98a579a9140"}}'
WHERE group_id = g_id;

INSERT INTO public.cms_layouts VALUES (gen_random_uuid(), false, '#3aae2a', '#9e9e9e', NULL, '2024-02-24 13:49:47.904+00', '2024-02-24 13:49:47.904+00', '[]', NULL, '2024-02-24 13:49:47.90375+00', NULL, g_id, false, NULL);
