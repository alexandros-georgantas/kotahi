...
UPDATE configs SET form_data = '{"user": {"isAdmin": false}, "report": {"showInMenu": true}, "review": {"showSummary": false}, "dashboard": {"loginRedirectUrl": "/admin/manuscripts"}, "kotahiApis": {}, "manuscript": {"tableColumns": "shortId, submission.articleId, submission.$title, created, updated, status, author", "newSubmission": true, "paginationCount": 10}, "publishing": {"webhook": {"ref": null, "url": null, "token": null}, "crossref": {"login": null, "password": null, "doiPrefix": null, "licenseUrl": null, "registrant": null, "useSandbox": false, "journalName": null, "depositorName": null, "depositorEmail": null, "journalHomepage": null, "publicationType": "article", "journalAbbreviatedName": null, "publishedArticleLocationPrefix": null}, "hypothesis": {"group": null, "apiKey": null, "reverseFieldOrder": false, "shouldAllowTagging": false}}, "submission": {"allowAuthorsSubmitNewVersion": false}, "taskManager": {"teamTimezone": "Etc/UTC"}, "controlPanel": {"showTabs": ["Metadata"], "authorProofingEnabled": false, "displayManuscriptShortId": true}, "instanceName": "preprint1", "notification": {"gmailAuthEmail": null, "gmailSenderEmail": null, "gmailAuthPassword": null}, "groupIdentity": {"logoPath": "/assets/logo-elife.svg", "brandName": "single_form", "primaryColor": "#0A9DD9", "secondaryColor": "#0A9DD9"}, "eventNotification": {"authorProofingSubmittedEmailTemplate": "74dc5295-6961-4567-a167-3b5179d6feb6", "authorProofingInvitationEmailTemplate": "b9721ebb-2bb0-4ca6-80c3-a067d86ef9f9", "reviewerInvitationPrimaryEmailTemplate": "f15ddf8b-b4ca-4184-8b7a-ca4dfc892075"}}'
WHERE group_id = g_id;

INSERT INTO public.cms_layouts VALUES (gen_random_uuid(), false, '#3aae2a', '#9e9e9e', NULL, '2024-02-24 13:49:58.193+00', '2024-02-24 13:49:58.193+00', '[]', NULL, '2024-02-24 13:49:58.192758+00', NULL, g_id, false, NULL);
...
('85e1300e-003c-4e96-987b-23812f902477', '2020-07-21 14:35:38.381+00', '2022-08-23 14:55:16.435+00', NULL, 'elaineb@example.com', 'Elaine Barnes', NULL, NULL, NULL, NULL, 'user', NULL, NULL, NULL, 'submissions', true, 'en-US'),
