...
const ENTER_URL_FIELD = 'TODO-fix-me!'
const TITLE_FIELD = '$title'
const NAME_FIELD = 'name'
const ABSTRACT_FIELD = '$abstract'
const DOI_FIELD = '$doi'
const SOURCE_URI_FIELD = '$sourceUri'
// const OUR_TAKE = 'ourTake'
const MAIN_FINDINGS = 'mainFindings'
const STUDY_STRENGTHS = 'studyStrengths'
const LIMITATIONS_FIELD = 'limitations'
...
const REVIEW_1_DATE_FEILD = 'review1date'
const REVIEW_2_DATE_FEILD = 'review2date'
const REVIEW_3_DATE_FEILD = 'review3date'
const SUMMARY_DATE = 'summarydate'
const REVIEW_1_CREATOR_FIELD = 'review1creator'
const REVIEW_2_CREATOR_FIELD = 'review2creator'
const REVIEW_3_CREATOR_FIELD = 'review3creator'
const SUMMARY_CREATOR_FIELD = 'summarycreator'

// specific to preprint2
const FIRST_AUTHOR_FIELD = 'firstAuthor'
const DATE_PUBLISHED_FIELD = 'datePublished'
const JOURNAL_FIELD = 'journal'
const REVIEWER_FIELD = 'reviewer'
const EDIT_DATE_FIELD = '$editDate'
const REVIEW_CREATOR_FIELD = 'reviewCreator'
// const DROPDOWN = '[class*=ValueContainer] > [class*=placeholder]'
const SUB_TOPICS_CHECKBOX_LIST = 'subTopics'
const TOPICS_CHECKBOX_LIST = 'topics'
